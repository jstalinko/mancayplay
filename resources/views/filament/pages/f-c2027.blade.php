    ...
    <div class="flex flex-col items-center justify-center gap-y-6 text-center" style="min-height: 50vh;">
        ...
        <div class="flex flex-col items-center gap-y-1">
            ...
            <p class="max-w-md text-base text-gray-600 dark:text-gray-400">
                Anda tidak memiliki akses kesini, beli lisensi FC 2027 terlebih dahulu untuk mengakses halaman ini.
            </p>
        </div>

        {{-- Tombol Aksi untuk Membeli Lisensi --}}
        <x-filament::button
            href="{{config('setting.fc2027_whatsapp_link')}}" {{-- TODO: Ganti dengan URL halaman pembelian lisensi Anda --}}
            tag="a"
...
<x-filament-panels::page>
    ...
    x-on:dark-mode-toggled.window="mode = $event.detail">
        ...
        <div class="flex justify-center pt-4 pb-8 mb-5  rounded-lg">
            ...
            <img src="{{ asset('fc27.png') }}" alt="FC 2027 Logo"  style="max-width:500px;max-height:200px" class="bg-white rounded-lg" />
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4" x-show="gridShow">
            ...
            <a href="{{config('setting.fc2027_download_link')}}" {{-- Ganti dengan URL unduhan atau wire:click action --}}
            ...
            <!-- Card 3: Discord -->
            <a href="{{config('setting.fc2027_discord_link')}}" {{-- Ganti dengan link undangan Discord Anda --}} target="_blank"
                class="block p-6 text-gray-900 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 dark:text-white transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center gap-4">
            ...
            <a href="{{config('setting.fc2027_whatsapp_link')}}" {{-- Ganti dengan link wa.me Anda --}} target="_blank"
                class="block p-6 text-gray-900 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 dark:text-white transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center gap-4">
            ...
            <a href="{{config('setting.fc2027_title_update_link')}}" {{-- Ganti dengan link wa.me Anda --}} target="_blank"
                class="block p-6 text-gray-900 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 dark:text-white transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center gap-4">
                    <div class="flex-shrink-0 p-3 bg-green-50 dark:bg-green-500/10 rounded-lg">
        ...
        <div x-show="!gridShow">
            ...
            <form method="POST" action="/request-token">
                @csrf
                <input type="hidden" name="type" value="fc2027">
